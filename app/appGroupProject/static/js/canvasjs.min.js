...
(function () {
    ...
    function hb(h) {
        if (!ib) {
            ...
            if (h.creditHref && h.creditText) {
                h._creditLink ||
                (h._creditLink = document.createElement("a"), h._creditLink.setAttribute("class", "canvasjs-chart-credit"), h._creditLink.setAttribute("title", "JavaScript Charts"), h._creditLink.setAttribute("style", "outline:none;margin:0px;position:absolute;right:2px;top:" + (h.height - 14) + "px;color:dimgrey;text-decoration:none;font-size:11px;font-family: sans-serif"), h._creditLink.setAttribute("tabIndex", -1), h._creditLink.setAttribute("target", "_blank"));
                if (0 === h.renderCount ||
    ...
    var $a = {}, xa = null, kb =
            ...
            return function (z, E, L) {
                ...
                L = S ? "getUTC" : "get";
                var U = z[L + "Date"](), V = z[L + "Day"](), M = z[L + "Month"](), Q = z[L + "FullYear"](),
                    a = z[L + "Hours"](), d = z[L + "Minutes"](), b = z[L + "Seconds"](), c = z[L + "Milliseconds"](),
            ...
            z && (Q === S && 0 < F.length) && (r = H + r); else "E" !== p[0] && "e" !== p[0] || "0" !== p[p.length - 1] || !/[eE][+-]*[0]+/.test(p) ? "," === p ? (Q++, z = O, O = 0, 0 < F.length && (r = H + r)) : r = 1 < p.length && ('"' === p[0] && '"' === p[p.length - 1] || "'" === p[0] && "'" === p[p.length - 1]) ? p.slice(1, p.length - 1) + r : p + r : (p = 0 > U ? p.replace("+", "").replace("-", "") : p.replace("-", ""), r += p.replace(/[0]+/, function (h) {
                return $(U, h.length)
            }));
            H = "";
            for (L = !1; 0 < R.length;) p = R.shift(), "#" === p || "0" === p ? 0 < h.length && 0 !== Number(h.join("")) ? (H += h.shift(), L = !0) : "0" === p && (H += "0", L =
                !0) : 1 < p.length && ('"' === p[0] && '"' === p[p.length - 1] || "'" === p[0] && "'" === p[p.length - 1]) ? H += p.slice(1, p.length - 1) : "E" !== p[0] && "e" !== p[0] || "0" !== p[p.length - 1] || !/[eE][+-]*[0]+/.test(p) ? H += p : (p = 0 > U ? p.replace("+", "").replace("-", "") : p.replace("-", ""), H += p.replace(/[0]+/, function (h) {
                return $(U, h.length)
            }));
            r += (L ? v : "") + H;
            return u ? "-" + r : r
    ...
    V.prototype.set = function (h, p, r) {
        ...
        if ("options" === h) this.createUserOptions(p); else if (u.hasOwnProperty(h) || u.publicProperties && u.publicProperties.hasOwnProperty(h) && "readWrite" === u.publicProperties[h]) this.options._isPlaceholder && this.createUserOptions(), this.options[h] = p; else {
            window.console && (u.publicProperties && u.publicProperties.hasOwnProperty(h) && "readOnly" === u.publicProperties[h] ? window.console.log('Property "' + h + '" is read-0nly.') : window.console.log('Property "' + h + "\" doesn't exist. Please check for typo."));
            return
        }
    ...
    V.prototype.addTo = function (h, p, r, u) {
        ...
        v.hasOwnProperty(h) || v.publicProperties && v.publicProperties.hasOwnProperty(h) && "readWrite" === v.publicProperties[h] ? (this.options._isPlaceholder && this.createUserOptions(), "undefined" === typeof this.options[h] && (this.options[h] = []), h = this.options[h], r = "undefined" === typeof r || null === r ? h.length : r, h.splice(r, 0, p), u && (this.chart || this).render()) : window.console &&
            (v.publicProperties && v.publicProperties.hasOwnProperty(h) && "readOnly" === v.publicProperties[h] ? window.console.log('Property "' + h + '" is read-0nly.') : window.console.log('Property "' + h + "\" doesn't exist. Please check for typo."))
    };
    ...
    Aa.prototype.setLayout = function () {
        if (this.text) {
            var h = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, p = h.layoutManager.getFreeSpace(),
                r = p.x1, v = p.y1, E = 0, H = 0,
    ...
    Na.Chart = function () {
        ...
        p.prototype._plotAreaMouseMove = function (a, d) {
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                var b = 0, c = 0, e = b = null, e = 0 <= this.zoomType.indexOf("x"),
                    g = 0 <= this.zoomType.indexOf("y"), k = this;
        ...
        p.prototype.renderIndexLabels = function (a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                var m = this._indexLabels[a], s = m.chartType.toLowerCase(), q, n,
                    l = na("indexLabelFontColor", m.dataPoint,
                ...
                if (null !== x && "" !== x) {
                    var t = na("indexLabelPlacement", m.dataPoint, m.dataSeries),
                        C = na("indexLabelOrientation", m.dataPoint, m.dataSeries), ma = m.direction,
                        y = m.dataSeries.axisX, A = m.dataSeries.axisY, v = !1, f = new ka(d, {
                            x: 0,
                            y: 0,
        ...
        p.prototype.renderLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var g = [], k, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (b.setLineDash) {
                        var n = R(m.nullDataLineDashType, m.lineThickness), q = m.lineDashType,
                    ...
                    if (0 < B.length) {
                        ...
                        for (g = 0; g < B.length; g++) if (B[g].getTime ? w = B[g].x.getTime() : w = B[g].x, !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax) && "number" === typeof B[g].y) {
                            ...
                            (B[g].indexLabel || f.indexLabel || B[g].indexLabelFormatter || f.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                dataPoint: B[g],
                                dataSeries: f,
                                point: {x: 0 <= B[g].y ? k : t, y: l + (p - l) / 2},
                                direction: 0 > B[g].y === a.axisY.reversed ? 1 : -1,
                                bounds: {x1: Math.min(t, k), y1: l, x2: Math.max(t, k), y2: p},
                                color: c
                            })
                        }
                    }
        ...
        p.prototype.renderArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    d = !0;
                    var h = 0, t, u, x,
                        v = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), y, A = null;
                    if (0 < p.length) {
                        var z = B._colorSet[h % B._colorSet.length], aa = B.lineColor = B.options.lineColor || z,
                            T = aa;
                        g.fillStyle = z;
                        g.strokeStyle = aa;
        ...
        p.prototype.renderSplineArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    e.fillStyle = l;
                    var l = [], f = 0, B, h,
                        p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), t, u = null,
                        x = [];
                    if (0 < n.length) {
                        ...
                        var z = "solid";
                        if (c.setLineDash) {
                            var aa = R(q.nullDataLineDashType, q.lineThickness), z = q.lineDashType,
        ...
        p.prototype.renderStepArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    b = !1;
                    if (0 < h.length) {
                        var z = B._colorSet[p % B._colorSet.length], aa = B.lineColor = B.options.lineColor || z,
                            T = aa;
                        g.fillStyle = z;
                        g.strokeStyle = aa;
                        g.lineWidth = B.lineThickness;
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var h = 25 * Math.PI, p = Math.max(Math.pow(0.25 * Math.min(c.height, c.width) / 2, 2) * Math.PI, h), m = 0; m < a.dataSeriesIndexes.length; m++) if (s = a.dataSeriesIndexes[m], q = this.data[s], n = q.dataPoints, 0 < n.length) for (b.strokeStyle = "#4572A7 ", e = 0; e < n.length; e++) if (g = n[e].getTime ? g = n[e].x.getTime() :
                    ...
                    (n[e].indexLabel || q.indexLabel || n[e].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
                        ...
                        point: {x: g, y: k},
                        direction: 1,
                        bounds: {x1: g - f.size / 2, y1: k - f.size / 2, x2: g + f.size / 2, y2: k + f.size / 2},
                        color: null
                    })
                }
                r && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas &&
        ...
        p.prototype.renderCandlestick = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, g = null, k = this.plotArea, l = 0, w, m, s, q, n, f,
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    "number" === typeof C[l].y[0] && "number" === typeof C[l].y[1] && "number" === typeof C[l].y[2] && "number" === typeof C[l].y[3]) {
                        ...
                        var z = w - h / 2 << 0, y = z + h << 0,
                            ...
                            e = C[l].color ? C[l].color : t._colorSet[0], A = Math.round(Math.max(1, 0.15 * h)),
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = !1, p = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    if (0 < x.length) for (var z = 5 < h && C.bevelEnabled ? !0 : !1, k = 0; k < x.length; k++) if (x[k].getTime ? f = x[k].x.getTime() : f = x[k].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && !u(x[k].y) && x[k].y.length && "number" === typeof x[k].y[0] && "number" === typeof x[k].y[1] && "number" === typeof x[k].y[2] && "number" === typeof x[k].y[3] && "number" === typeof x[k].y[4] && 5 === x[k].y.length) {
                        ...
                        var y = l - h / 2 << 0, A = l + h / 2 << 0, e = x[k].color ? x[k].color : C._colorSet[0],
                            ...
                            G = 1 === Math.round(la) % 2 ? 0.5 : 0, F = x[k].stemDashType ? x[k].stemDashType :
                            C.stemDashType,
                            ...
                            K = 1 === Math.round(H) % 2 ? 0.5 : 0, L = C.upperBoxColor, O = C.lowerBoxColor,
                            Q = u(C.options.fillOpacity) ? 1 : C.fillOpacity, P = C.dataPointIds[k];
                    ...
                    if (0 < h.length) {
                        ...
                        for (g = 0; g < h.length; g++) if (h[g].getTime ? m = h[g].x.getTime() : m = h[g].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && !u(h[g].y) && h[g].y.length && "number" === typeof h[g].y[0] && "number" === typeof h[g].y[1]) {
                            ...
                            if (h[g].indexLabel || f.indexLabel || h[g].indexLabelFormatter || f.indexLabelFormatter) this._indexLabels.push({
                                ...
                                dataSeries: f,
                                indexKeyword: 0,
                                point: {x: h[g].y[1] >= h[g].y[0] ? k : l, y: w + (v - w) / 2},
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < q.length) {
                        ...
                        var A = "solid";
                        if (c.setLineDash) {
                            var z = R(s.nullDataLineDashType, s.lineThickness), A = s.lineDashType,
        ...
        p.prototype.renderPie = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var m =
                        this.data[a.dataSeriesIndexes[0]], s = m.dataPoints, q = 10, n = this.plotArea, f = m.dataPointEOs,
                    p = 2, r, v = 1.3, t = 20 / 180 * Math.PI, C = 6, x = {x: (n.x2 + n.x1) / 2, y: (n.y2 + n.y1) / 2},
                    z = 0;
                a = !1;
        ...
        H.prototype.render = function () {
            ...
            for (var l = 0, h = 0; h < k.length; h++) {
                for (var m = k[h], s = 0, q = 0; q < m.items.length; q++) {
                    var n = m.items[q], f = n.textBlock.x + a + (0 === q ? 0.2 * g : this.horizontalSpacing), p = d + l,
                        u = f;
        ...
        F.prototype.getDataPointAtX = function (a, d) {
            ...
            var b = {dataPoint: null, distance: Infinity, index: NaN}, c = null, e = 0, g = 0, k = 1, l = Infinity,
                h = 0, m = 0, s = 0;
        ...
        L.prototype.render = function (a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                this.ctx.globalCompositeOperation = "destination-0ver";
                this.ctx.fill();
                this.ctx.restore();
        ...
        $.prototype.highlightObjects = function (a) {
            ...
            for (b = 0; b < a.length; b++) {
                ...
                if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                    var c = this.chart.data[e.dataSeriesIndex], g = c.dataPoints[e.dataPointIndex],
                        k = e.dataPointIndex;
        ...
        $.prototype.getContainerTransition = function (a) {
            return "left " + a + "s ease-0ut 0s, bottom " + a + "s ease-0ut 0s"
        };
